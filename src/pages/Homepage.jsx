  ...
  return (
    <div className="min-h-screen bg-[#161515] flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-white text-4xl font-semibold mb-4">Enjoy The World In Briefs</h1>
        <p className="text-[#9A9A9A] mb-8 text-xs md:text-xl ">
          Create viral videos effortlessly with Zoomerang! Trendy effects, <br /> seamless transitions, and powerful
